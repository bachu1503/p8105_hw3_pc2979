...
ny_noaa %>%
  ...
  geom_line(aes(show.legend = FALSE, alpha = 0.5)) +
  ...
  scale_x_continuous(n.breaks = 15)+theme(axis.text.x = element_text(angle = -75))
```
...
snow_year <-
  ...
  ggplot(aes(x = year, y = snow, alpha = 0.5)) +
  geom_violin(aes(fill = year), color = "green") +
